...
#
# rebuild_project.tcl: Tcl script for re-creating project 'pwm'
#
# Generated by Vivado on Tue Feb 03 09:46:06 +0530 2026
...
#
#    "D:/PWM_CONTROLLER/pwm/pwm.srcs/constrs_1/new/pins.xdc"
#    "D:/PWM_CONTROLLER/pwm/pwm.srcs/utils_1/imports/synth_1/system_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/pwm.srcs/constrs_1/new/pins.xdc"]"\
 "[file normalize "$origin_dir/pwm.srcs/utils_1/imports/synth_1/system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../ip_repo/my_pwm_1_0"]"]"\
  ]
  foreach ipath $paths {
...
set_property -name "board_part_repo_paths" -value "C:/Users/Lenovo/AppData/Roaming/Xilinx/Vivado/2025.2/xhub/board_store/xilinx_board_store" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../ip_repo/my_pwm_1_0"]" $obj
...
set file "[file normalize "$origin_dir/pwm.srcs/constrs_1/new/pins.xdc"]"
...
\
  ...
  # Create instance: my_pwm_0, and set properties
  set my_pwm_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:my_pwm:1.0 my_pwm_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins my_pwm_0/S00_AXI]
  ...
  [get_bd_pins my_pwm_0/s00_axi_aclk] \
  ...
  [get_bd_pins my_pwm_0/s00_axi_aresetn] \
  [get_bd_pins axi_smc/aresetn] \
  [get_bd_pins axi_gpio_0/s_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_pwm_0/S00_AXI/S00_AXI_reg] -force
...
if { [get_property IS_LOCKED [ get_files -norecurse [list system.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/pwm.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
